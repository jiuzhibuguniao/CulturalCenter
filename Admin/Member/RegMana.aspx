<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegMana.aspx.cs" Inherits="CulturalCenter.RegMana" Theme="GreenT" %>
...
<body>
    ...
    <table style="width: 95%;" cellpadding="2" cellspacing="1" class="border">
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    ...
                    AutoGenerateColumns="false" PageSize="20"  RowStyle-HorizontalAlign="Center" OnRowCreated="gridView_OnRowCreated" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="类型"  ItemStyle-Width="80px">
                            ...
                            <asp:HyperLinkField HeaderText="审核"  ItemStyle-Width="40px" DataNavigateUrlFields="MemberID" DataNavigateUrlFormatString="SelfInfoModify.aspx?id={0}&flag=1"
                                Text="审核"  />
                            </Columns>
                        <EmptyDataTemplate>
                        <table>
