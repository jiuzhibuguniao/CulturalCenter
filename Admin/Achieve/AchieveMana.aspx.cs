...
{
    public partial class AchieveMana : System.Web.UI.Page
    {
        Cultural.BLL.Achievement bll = new Cultural.BLL.Achievement();
        ...
        public void BindData()
        {
            ...
            {
                strWhere.AppendFormat("AchieveName like '%{0}%'   and Status !='0' ", txtKeyword.Text.Trim());
            }
            else
            {
