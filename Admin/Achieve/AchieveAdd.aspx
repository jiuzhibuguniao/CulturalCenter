<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AchieveAdd.aspx.cs" Inherits="CulturalCenter.Admin.Achieve.AchieveAdd" Theme="GreenT" %>
...
<body>
    ...
    <div id="AchBox" class="achBox">
        <table>
            <tr>
                <td colspan="3">
                    项 目 名：<asp:TextBox ID="txtAchName" runat="server" Width="400px"></asp:TextBox>
                </td>
            </tr>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <span id="SpanfileName" style="font-weight:normal;color:#808080;font-size:12px;"></span>
                </td>
            </tr>
        </table>
        <asp:HiddenField ID="hidFileNewName" runat="server" Value=""/>
