<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNews.aspx.cs" Inherits="CulturalCenter.Admin.News.AddNews" Theme="GreenT"  ValidateRequest="false"%>
	    ...
	    KindEditor.ready(function (K) {
	        editor = K.create('input[id="txtContent"]', {
	            ...
	            items: [
                    ...
                    'insertunorderedlist', '|', 'emoticons', 'image', 'link','|','cut','copy','paste','plainpaste','print']
	        });
	    });
        ...
        <div style="width:700px;">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        一级<asp:DropDownList ID="ddlPBoardID" runat="server" Width="100px" AutoPostBack="True" OnSelectedIndexChanged="ddlPBoardID_SelectedIndexChanged"></asp:DropDownList>
                        &nbsp;&nbsp;&nbsp;&nbsp;二级<asp:DropDownList ID="ddlSBoardID" runat="server" Width="100px"></asp:DropDownList>
                    </td>
                    <td style="width:50px;">置顶</td>
                    <td>
                        <asp:DropDownList ID="ddlTopShow" runat="server"  Width="50px">
                    ...
                    <td style="width:60px;height:60px; padding:0px 20px;">
                        <asp:Button ID="btnAdd" runat="server" Text="添加" Height="60" Width="60" ForeColor="#006600" Font-Size="12pt" OnClick="btnAdd_Click" /></td>
                    </tr>
            </table>
            <br />
            <div>
            ...
            <div>
                <table style="background-color:#f5fbf7;width:700px;">
	                ...
	                <td width="80" align="right" valign="middle">
                        <span style="display:block;text-align:left;vertical-align:middle;width:80px;height:30px;float:right;padding-top:0px;">图片上传：</span>
		               </td>
	                <td  width="*" align="left" colspan="3" valign="middle" >
                        ...
                        <td width="60px"><img id="NewsPic" alt="" src="" width="60px" /></td>
                    </tr>
                </table>
            </div>
            <div>
                <table style="background-color:#f5fbf7;width:700px;">
                    <tr>
	                <td width="80" align="right" valign="middle">
                        <div style="display:block;text-align:left;vertical-align:middle;width:80px;height:80px;float:right;padding-top:0px;"> 附件上传：</div>
		               </td>
                    ...
                    <tr><td colspan="2"><span id="fileUpRes" style="color:#808080;"></span></td></tr>
                </table>
            </div>
        </div>
    </div>
